...
func ReadCharacterDataComponent(ctx *runtime.ReadContext, addr uintptr) (*CharacterDataComponent, runtime.Errors) {
	...
	result.FlyTime = math.Float32frombits(binary.LittleEndian.Uint32(buf[140:]))
...
func ReadDamageModelComponent(ctx *runtime.ReadContext, addr uintptr) (*DamageModelComponent, runtime.Errors) {
	...
	result.Unknown68 = binary.LittleEndian.Uint32(buf[104:])
	result.DmgMultMelee = math.Float32frombits(binary.LittleEndian.Uint32(buf[108:]))
	result.DmgMultProjectile = math.Float32frombits(binary.LittleEndian.Uint32(buf[112:]))
	result.DmgMultExplosion = math.Float32frombits(binary.LittleEndian.Uint32(buf[116:]))
	result.DmgMultElectricity = math.Float32frombits(binary.LittleEndian.Uint32(buf[120:]))
	result.DmgMultFire = math.Float32frombits(binary.LittleEndian.Uint32(buf[124:]))
	result.DmgMultDrill = math.Float32frombits(binary.LittleEndian.Uint32(buf[128:]))
	result.DmgMultSlice = math.Float32frombits(binary.LittleEndian.Uint32(buf[132:]))
	result.DmgMultIce = math.Float32frombits(binary.LittleEndian.Uint32(buf[136:]))
	result.DmgMultHealing = math.Float32frombits(binary.LittleEndian.Uint32(buf[140:]))
	result.DmgMultPhysicsHit = math.Float32frombits(binary.LittleEndian.Uint32(buf[144:]))
	result.DmgMultRadioactive = math.Float32frombits(binary.LittleEndian.Uint32(buf[148:]))
	result.DmgMultPoison = math.Float32frombits(binary.LittleEndian.Uint32(buf[152:]))
	result.DmgMultHoly = math.Float32frombits(binary.LittleEndian.Uint32(buf[156:]))
	result.DmgMultCurse = math.Float32frombits(binary.LittleEndian.Uint32(buf[160:]))
	result.DmgMultOvereating = math.Float32frombits(binary.LittleEndian.Uint32(buf[164:]))
	result.DmgMultMaterial = math.Float32frombits(binary.LittleEndian.Uint32(buf[168:]))
